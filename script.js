  ...
  _createClass(VideoPlayer, [{
    ...
    value: function bindTriggers() {
      ...
      this.btns.forEach(function (item, i) {
        ...
        item.addEventListener('click', function () {
          if (!item.closest('.module__video-item') || item.closest('.module__video-item').getAttribute('data-disable') !== 'true') {
...
function (_Slider) {
  ...
  function MiniSlider(page, next, prev, activeClass, animate, autoPlay) {
    _classCallCheck(this, MiniSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, page, next, prev, activeClass, animate, autoPlay));
  }
